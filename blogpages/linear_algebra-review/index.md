...
### A brief travel in time:
  ...
  Around the turn of 200 B.C, the Chinese published the ["The Nine Chapters on the Mathematical Art"]("https://en.wikipedia.org/wiki/The_Nine_Chapters_on_the_Mathematical_Art") in which they introduces a way of solving 3x3 equations which is now called the referred to as $$Gaussian Elimination^{[1]}$$. However, it was not until the 17th century the power of Linear Algebra was known.\
  ...
  Arthur Cayley introduced matrix multiplication and the inverse matrix in 1856,
